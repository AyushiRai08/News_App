...
// My Api 
const API_KEY = "a6ff776e177c4b14833bb7d27e71107e"
...
const news_input = document.querySelector(".news-input");

news_input.addEventListener('keydown', (e)=>{
  if(e.key=='Enter'){
    const yourSearch = news_input.value;
...
async function fetchNews(query) {
  ...
  // const apiData = await fetch(`https://newsapi.org/v2/everything?q=India&apiKey=8f8d4fdf20034dfaabc1c21fc6812183`);
  ...
  if (fetchedData.totalResults != 0) {
    ...
    errorMess.textContent =
      "OOPS! Error😮...dekh kya raha hai, input sahi daal";
  }
}
